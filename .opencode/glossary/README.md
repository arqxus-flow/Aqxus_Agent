...
Use this folder for locale-specific translation guidance that supplements `.orbi/agent/translator.md`.
...
- PR #12345: https://github.com/anomalyco/orbi/pull/12345

## Do Not Translate (Locale Additions)

- `Orbi` (preserve casing)
