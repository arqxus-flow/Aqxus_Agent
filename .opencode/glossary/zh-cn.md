...
- PR #13942: https://github.com/anomalyco/orbi/pull/13942

## Do Not Translate (Locale Additions)

- `Orbi` (preserve casing in prose; keep `orbi` only when it is part of commands, package names, paths, or code)
- `Orbi Zen`
- `Orbi CLI`
- `CLI`, `TUI`, `MCP`, `OAuth`
...
- Avoid `orbi` in prose when referring to the product name; use `Orbi`
