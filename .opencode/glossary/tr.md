...
- PR #15835: https://github.com/anomalyco/orbi/pull/15835

## Do Not Translate (Locale Additions)

- `Orbi` (preserve casing in prose, docs, and UI copy)
- Keep lowercase `orbi` in commands, package names, paths, URLs, and other exact identifiers
...
- Keep product naming consistent: `Orbi` in prose, `orbi` only for exact technical identifiers
...
- Avoid changing `orbi` to `Orbi` inside commands, URLs, package names, or code literals
