...
test("parses https URL with .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/orbi.git")).toEqual({ owner: "sst", repo: "orbi" })
})

test("parses https URL without .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/orbi")).toEqual({ owner: "sst", repo: "orbi" })
})

test("parses git@ URL with .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/orbi.git")).toEqual({ owner: "sst", repo: "orbi" })
})

test("parses git@ URL without .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/orbi")).toEqual({ owner: "sst", repo: "orbi" })
})

test("parses ssh:// URL with .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/orbi.git")).toEqual({ owner: "sst", repo: "orbi" })
})

test("parses ssh:// URL without .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/orbi")).toEqual({ owner: "sst", repo: "orbi" })
})
