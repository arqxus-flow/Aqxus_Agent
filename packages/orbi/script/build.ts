...
const modelsUrl = process.env.ORBI_MODELS_URL || "https://models.dev"
...
for (const item of targets) {
  ...
  await Bun.build({
    ...
    compile: {
      ...
      outfile: `dist/${name}/bin/orbi`,
      execArgv: [`--user-agent=orbi/${Script.version}`, "--use-system-ca", "--"],
      windows: {},
    },
    entrypoints: ["./src/index.ts", parserWorker, workerPath],
    define: {
      ORBI_VERSION: `'${Script.version}'`,
      ORBI_MIGRATIONS: JSON.stringify(migrations),
      OTUI_TREE_SITTER_WORKER_PATH: bunfsRoot + workerRelativePath,
      ORBI_WORKER_PATH: workerPath,
      ORBI_CHANNEL: `'${Script.channel}'`,
      ORBI_LIBC: item.os === "linux" ? `'${item.abi ?? "glibc"}'` : "",
    },
  })
