...
/**
 * Server configuration for orbi serve and web commands
 */
export type ServerConfig = {
  ...
  mdns?: boolean
  /**
   * Custom domain name for mDNS service (default: orbi.local)
   */
  mdnsDomain?: string
  /**
...
export type Config = {
  ...
  server?: ServerConfig
  /**
   * Command configuration, see https://orbicowork.arqxus.com/docs/commands
   */
  command?: {
    [key: string]: {
      template: string
  ...
  /**
   * Agent configuration, see https://orbicowork.arqxus.com/docs/agents
   */
  agent?: {
    plan?: AgentConfig
    build?: AgentConfig
