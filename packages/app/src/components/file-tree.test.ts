...
beforeAll(async () => {
  ...
  mock.module("@orbi/ui/collapsible", () => ({
    Collapsible: {
      Trigger: (props: { children?: unknown }) => props.children,
      Content: (props: { children?: unknown }) => props.children,
    },
  }))
  mock.module("@orbi/ui/file-icon", () => ({ FileIcon: () => null }))
  mock.module("@orbi/ui/icon", () => ({ Icon: () => null }))
  mock.module("@orbi/ui/tooltip", () => ({ Tooltip: (props: { children?: unknown }) => props.children }))
