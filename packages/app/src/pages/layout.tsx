...
import { ResizeHandle } from "@orbi/ui/resize-handle"
...
import { Session, type Message } from "@orbi/sdk/v2/client"
...
import { showToast, Toast, toaster } from "@orbi/ui/toast"
...
import { useTheme, type ColorScheme } from "@orbi/ui/theme"
...
export default function Layout(props: ParentProps) {
  ...
  const sidebarContent = (mobile?: boolean) => (
    <SidebarContent
      ...
      onOpenHelp={() => platform.openLink("https://orbicowork.arqxus.com/desktop-feedback")}
      renderPanel={() =>
