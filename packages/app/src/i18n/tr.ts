...
export const dict = {
  ...
  "dialog.provider.orbi.note": "Claude, GPT, Gemini ve daha fazlasını içeren seçilmiş modeller",
  "dialog.provider.orbi.tagline": "Güvenilir optimize edilmiş modeller",
  "dialog.provider.orbiGo.tagline": "Herkes için düşük maliyetli abonelik",
  ...
  "dialog.model.unpaid.freeModels.title": "Orbi tarafından sunulan ücretsiz modeller",
  ...
  "provider.connect.apiKey.description":
    "{{provider}} hesabınızı bağlamak ve Orbi'da {{provider}} modellerini kullanmak için {{provider}} API anahtarınızı girin.",
  ...
  "provider.connect.orbiZen.line1":
    "Orbi Zen, kodlama ajanları için seçilmiş güvenilir optimize edilmiş modellere erişim sağlar.",
  ...
  "provider.connect.orbiZen.visit.prefix": "",
  "provider.connect.orbiZen.visit.link": "orbicowork.arqxus.com/zen",
  "provider.connect.orbiZen.visit.suffix": " adresini ziyaret ederek API anahtarınızı alın.",
  "provider.connect.oauth.code.visit.prefix":
    "Hesabınızı bağlamak ve Orbi'da {{provider}} modellerini kullanmak için ",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " tıklayarak aşağıdaki kodu girin ve hesabınızı bağlayarak Orbi'da {{provider}} modellerini kullanın.",
  ...
  "dialog.plugins.empty": "Eklentiler orbi.json içinde yapılandırılır",
  ...
  "dialog.server.description": "Bu uygulamanın hangi Orbi sunucusuna bağlanacağını değiştirin.",
  ...
  "toast.update.description": "Orbi'un yeni bir sürümü ({{version}}) yüklemeye hazır.",
  ...
  "error.page.report.prefix": "Lütfen bu hatayı Orbi ekibine bildirin",
  ...
  "error.chain.checkConfig": "Yapılandırma dosyanızı (orbi.json) sağlayıcı/model adlarını kontrol edin",
  "error.chain.mcpFailed":
    'MCP sunucusu "{{name}}" başarısız oldu. Not: Orbi henüz MCP kimlik doğrulamasını desteklemiyor.',
  ...
  "sidebar.gettingStarted.line1": "Orbi ücretsiz modeller içerir, böylece hemen başlayabilirsiniz.",
  ...
  "app.name.desktop": "Orbi Masaüstü",
  ...
  "settings.desktop.wsl.description": "Orbi sunucusunu Windows'ta WSL içinde çalıştırın.",
  ...
  "settings.general.row.language.description": "Orbi'un görünüm dilini değiştirin",
  "settings.general.row.appearance.title": "Görünüm",
  "settings.general.row.appearance.description": "Orbi'un cihazınızdaki görünümünü özelleştirin",
  "settings.general.row.colorScheme.title": "Renk şeması",
  "settings.general.row.colorScheme.description":
    "Orbi'un sistem, açık veya koyu temayı takip etip etmeyeceğini seçin",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Orbi'un temasını özelleştirin.",
  ...
  "settings.updates.row.startup.description": "Orbi başladığında otomatik güncelleme kontrolü yap",
  ...
  "settings.updates.toast.latest.description": "Orbi'un en son sürümünü kullanıyorsunuz.",
