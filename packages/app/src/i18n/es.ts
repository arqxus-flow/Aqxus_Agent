export const dict = {
  ...
  "dialog.provider.orbi.note": "Modelos seleccionados incluyendo Claude, GPT, Gemini y más",
  "dialog.provider.orbi.tagline": "Modelos optimizados y fiables",
  "dialog.provider.orbiGo.tagline": "Suscripción económica para todos",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos proporcionados por Orbi",
  ...
  "provider.connect.apiKey.description":
    "Introduce tu clave API de {{provider}} para conectar tu cuenta y usar modelos de {{provider}} en Orbi.",
  ...
  "provider.connect.orbiZen.line1":
    "Orbi Zen te da acceso a un conjunto curado de modelos fiables optimizados para agentes de programación.",
  "provider.connect.orbiZen.line2":
    "Con una sola clave API obtendrás acceso a modelos como Claude, GPT, Gemini, GLM y más.",
  "provider.connect.orbiZen.visit.prefix": "Visita ",
  "provider.connect.orbiZen.visit.link": "orbicowork.arqxus.com/zen",
  "provider.connect.orbiZen.visit.suffix": " para obtener tu clave API.",
  "provider.connect.oauth.code.visit.prefix": "Visita ",
  "provider.connect.oauth.code.visit.link": "este enlace",
  "provider.connect.oauth.code.visit.suffix":
    " para obtener tu código de autorización para conectar tu cuenta y usar modelos de {{provider}} en Orbi.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e introduce el código a continuación para conectar tu cuenta y usar modelos de {{provider}} en Orbi.",
  ...
  "dialog.plugins.empty": "Plugins configurados en orbi.json",
  ...
  "dialog.server.description": "Cambiar a qué servidor de Orbi se conecta esta app.",
  ...
  "toast.update.description": "Una nueva versión de Orbi ({{version}}) está disponible para instalar.",
  ...
  "error.page.report.prefix": "Por favor reporta este error al equipo de Orbi",
  ...
  "error.chain.checkConfig": "Comprueba los nombres de proveedor/modelo en tu configuración (orbi.json)",
  "error.chain.mcpFailed": 'El servidor MCP "{{name}}" falló. Nota, Orbi no soporta autenticación MCP todavía.',
  ...
  "sidebar.gettingStarted.line1": "Orbi incluye modelos gratuitos para que puedas empezar inmediatamente.",
  ...
  "settings.desktop.wsl.description": "Ejecutar el servidor Orbi dentro de WSL en Windows.",
  ...
  "settings.general.row.language.description": "Cambiar el idioma de visualización para Orbi",
  "settings.general.row.appearance.title": "Apariencia",
  "settings.general.row.appearance.description": "Personaliza cómo se ve Orbi en tu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de color",
  "settings.general.row.colorScheme.description": "Elige si Orbi sigue el tema del sistema, claro u oscuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personaliza el tema de Orbi.",
  ...
  "settings.updates.row.startup.description": "Buscar actualizaciones automáticamente cuando se inicia Orbi",
  ...
  "settings.updates.toast.latest.description": "Estás usando la última versión de Orbi.",
