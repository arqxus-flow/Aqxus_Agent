export const dict = {
  ...
  "dialog.provider.orbi.note": "Wyselekcjonowane modele, w tym Claude, GPT, Gemini i inne",
  "dialog.provider.orbi.tagline": "Niezawodne, zoptymalizowane modele",
  "dialog.provider.orbiGo.tagline": "Tania subskrypcja dla każdego",
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez Orbi",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w Orbi.",
  ...
  "provider.connect.orbiZen.line1":
    "Orbi Zen daje dostęp do wybranego zestawu niezawodnych, zoptymalizowanych modeli dla agentów kodujących.",
  "provider.connect.orbiZen.line2":
    "Z jednym kluczem API uzyskasz dostęp do modeli takich jak Claude, GPT, Gemini, GLM i więcej.",
  "provider.connect.orbiZen.visit.prefix": "Odwiedź ",
  "provider.connect.orbiZen.visit.link": "orbicowork.arqxus.com/zen",
  "provider.connect.orbiZen.visit.suffix": ", aby odebrać swój klucz API.",
  "provider.connect.oauth.code.visit.prefix": "Odwiedź ",
  "provider.connect.oauth.code.visit.link": "ten link",
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w Orbi.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w Orbi.",
  ...
  "dialog.plugins.empty": "Wtyczki skonfigurowane w orbi.json",
  ...
  "dialog.server.description": "Przełącz serwer Orbi, z którym łączy się ta aplikacja.",
  ...
  "toast.update.description": "Nowa wersja Orbi ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu Orbi",
  ...
  "error.chain.checkConfig": "Sprawdź swoją konfigurację (orbi.json) nazwy dostawców/modeli",
  ...
  "sidebar.gettingStarted.line1": "Orbi zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla Orbi",
  "settings.general.row.appearance.title": "Wygląd",
  "settings.general.row.appearance.description": "Dostosuj wygląd Orbi na swoim urządzeniu",
  "settings.general.row.colorScheme.title": "Schemat kolorów",
  "settings.general.row.colorScheme.description":
    "Wybierz, czy Orbi ma używać motywu systemowego, jasnego czy ciemnego",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw Orbi.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania Orbi",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji Orbi.",
