export const dict = {
  ...
  "dialog.provider.orbi.note": "Kurirani modeli uključujući Claude, GPT, Gemini i druge",
  "dialog.provider.orbi.tagline": "Pouzdani optimizovani modeli",
  "dialog.provider.orbiGo.tagline": "Povoljna pretplata za sve",
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatni modeli koje obezbjeđuje Orbi",
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u Orbi-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u Orbi-u.",
  ...
  "dialog.plugins.empty": "Plugini su konfigurisani u orbi.json",
  ...
  "dialog.server.description": "Promijeni na koji se Orbi server ova aplikacija povezuje.",
  ...
  "toast.update.description": "Nova verzija Orbi-a ({{version}}) je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Molimo prijavi ovu grešku Orbi timu",
  ...
  "error.chain.checkConfig": "Provjeri konfiguraciju (orbi.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" nije uspio. Napomena: Orbi još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "Orbi uključuje besplatne modele, tako da možeš odmah početi.",
  ...
  "settings.desktop.wsl.description": "Pokreni Orbi server unutar WSL-a na Windowsu.",
  ...
  "settings.general.row.language.description": "Promijeni jezik prikaza u Orbi-u",
  "settings.general.row.appearance.title": "Izgled",
  "settings.general.row.appearance.description": "Prilagodi kako Orbi izgleda na tvom uređaju",
  "settings.general.row.colorScheme.title": "Šema boja",
  "settings.general.row.colorScheme.description": "Odaberi da li Orbi prati sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu Orbi-a.",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se Orbi pokrene",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju Orbi-a.",
