...
import compareVideo from "../../asset/lander/orbi-comparison-min.mp4"
import compareVideoPoster from "../../asset/lander/orbi-comparison-poster.png"
...
export default function Home() {
  ...
  return (
    <main data-page="zen">
      ...
      <Meta name="orbi:auth" content={loggedin() ? "true" : "false"} />
