...
import desktopAppIcon from "../../asset/lander/orbi-desktop-icon.png"
      ...
      <div data-component="container">
        ...
        <div data-component="content">
          ...
          <section data-component="download-section">
            ...
            <div data-component="section-content">
              <button
                ...
                onClick={handleCopyClick("curl -fsSL https://orbicowork.arqxus.com/install | bash")}
              >
                <code>
                  curl -fsSL https://<strong>orbicowork.arqxus.com/install</strong> | bash
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("npm i -g orbi")}>
                <code>
                  npm i -g <strong>orbi</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("bun add -g orbi")}>
                <code>
                  bun add -g <strong>orbi</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("brew install anomalyco/tap/orbi")}>
                <code>
                  brew install <strong>anomalyco/tap/orbi</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("paru -S orbi")}>
                <code>
                  paru -S <strong>orbi</strong>
                </code>
                <CopyStatus />
              </button>
            </div>
          ...
          <section data-component="download-section">
            ...
            <div data-component="section-content">
              <button data-component="cli-row" onClick={handleCopyClick("brew install --cask orbi-desktop")}>
                <code>
                  brew install --cask <strong>orbi-desktop</strong>
                </code>
                <CopyStatus />
              </button>
