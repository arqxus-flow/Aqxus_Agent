...
const docs = `### Overview
Loads Orbi typography assets and mono nerd fonts.
...
export const Basic = {
  render: () => (
    <div style={{ display: "grid", gap: "8px" }}>
      <mod.Font />
      <div style={{ "font-family": "var(--font-family-sans)" }}>Orbi Sans Sample</div>
      <div style={{ "font-family": "var(--font-family-mono)" }}>Orbi Mono Sample</div>
    </div>
  ),
}
