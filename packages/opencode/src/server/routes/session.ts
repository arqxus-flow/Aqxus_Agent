  ...
  new Hono()
    .get(
      ...
      describeRoute({
        ...
        description: "Get a list of all Orbi sessions, sorted by most recently updated.",
    ...
    .get(
      ...
      describeRoute({
        summary: "Get session",
        description: "Retrieve detailed information about a specific Orbi session.",
        tags: ["Session"],
    ...
    .post(
      ...
      describeRoute({
        ...
        description: "Create a new Orbi session for interacting with AI assistants and managing conversations.",
