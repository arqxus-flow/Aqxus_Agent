...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders ORBI_CALLER", () => {
    process.env["ORBI_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode ORBI_CALLER", () => {
    process.env["ORBI_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown ORBI_CALLER", () => {
    process.env["ORBI_CALLER"] = "unknown"
