export const dict = {
  ...
  "desktop.menu.help.documentation": "Orbi Dokumentasjon",
  ...
  "desktop.cli.error.sidecarMissing": "Orbi CLI-binærfil mangler. Prøv å installere skrivebordsappen på nytt.",
