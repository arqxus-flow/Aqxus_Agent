    ...
    items: [
      ...
      await Submenu.new({
        ...
        items: [
          ...
          await MenuItem.new({
            action: () => openUrl("https://orbicowork.arqxus.com/docs"),
            text: t("desktop.menu.help.documentation"),
          }),
          await MenuItem.new({
            action: () => openUrl("https://discord.com/invite/orbi"),
          ...
          await MenuItem.new({
            action: () => openUrl("https://github.com/anomalyco/orbi/issues/new?template=feature_request.yml"),
            text: t("desktop.menu.help.shareFeedback"),
          }),
          await MenuItem.new({
            action: () => openUrl("https://github.com/anomalyco/orbi/issues/new?template=bug_report.yml"),
