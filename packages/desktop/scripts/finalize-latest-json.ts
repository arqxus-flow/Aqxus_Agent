...
const releaseId = process.env.ORBI_RELEASE
if (!releaseId) throw new Error("ORBI_RELEASE is required")

const version = process.env.ORBI_VERSION
if (!releaseId) throw new Error("ORBI_VERSION is required")
...
const targets = [
  { key: "linux-x86_64-deb", asset: "orbi-desktop-linux-amd64.deb" },
  { key: "linux-x86_64-rpm", asset: "orbi-desktop-linux-x86_64.rpm" },
  { key: "linux-aarch64-deb", asset: "orbi-desktop-linux-arm64.deb" },
  { key: "linux-aarch64-rpm", asset: "orbi-desktop-linux-aarch64.rpm" },
  { key: "windows-aarch64-nsis", asset: "orbi-desktop-windows-arm64.exe" },
  { key: "windows-x86_64-nsis", asset: "orbi-desktop-windows-x64.exe" },
  { key: "darwin-x86_64-app", asset: "orbi-desktop-darwin-x64.app.tar.gz" },
  {
    key: "darwin-aarch64-app",
    asset: "orbi-desktop-darwin-aarch64.app.tar.gz",
  },
]
