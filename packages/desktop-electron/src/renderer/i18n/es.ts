export const dict = {
  ...
  "desktop.updater.none.message": "Ya estás usando la versión más reciente de Orbi",
  ...
  "desktop.updater.downloaded.prompt":
    "Se ha descargado la versión {{version}} de Orbi. ¿Quieres instalarla y reiniciar?",
