...
- PR #10809: https://github.com/anomalyco/orbi/pull/10809
- PR #11496: https://github.com/anomalyco/orbi/pull/11496

## Do Not Translate (Locale Additions)

- `Orbi` (preserve casing in prose; keep `orbi` only in commands, package names, paths, or code)
- `Orbi CLI`
- `CLI`, `TUI`, `MCP`, `OAuth`
